...
**
** Created: Thu 29. Nov 11:56:27 2012
...
static const char qt_meta_stringdata_serial[] = {
    "serial\0\0Error(QString)\0read()\0"
    "clearError()\0"
};
...
const QMetaObject serial::staticMetaObject = {
    { &QextSerialPort::staticMetaObject, qt_meta_stringdata_serial,
...
static const char qt_meta_stringdata_deviceButton[] = {
    "deviceButton\0\0resetDevice()\0S\0"
    "errorOccured(QString)\0"
};
...
const QMetaObjectExtraData deviceButton::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject deviceButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_deviceButton,
      qt_meta_data_deviceButton, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &deviceButton::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_deviceButton))
