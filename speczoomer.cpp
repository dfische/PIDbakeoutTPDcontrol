...
//    setMousePattern(QwtEventPattern::MouseSelect3, Qt::MidButton, Qt::ControlModifier);
    setMousePattern(QwtEventPattern::MouseSelect2, Qt::LeftButton, Qt::ControlModifier);
    setMousePattern(QwtEventPattern::MouseSelect5, Qt::MidButton, Qt::ControlModifier);
