...
**
** Created: Wed 12. Dec 11:33:13 2012
...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        layoutWidget->setGeometry(QRect(12, 12, 741, 811));
        ...
        PIDtempSpinBox = new QSpinBox(layoutWidget);
        ...
        resetPID = new deviceButton(layoutWidget);
        ...
        heaterOutput1Ohm = new QComboBox(layoutWidget);
        ...
        setpoint1 = new QDoubleSpinBox(layoutWidget);
        setpoint1->setObjectName(QString::fromUtf8("setpoint1"));
        setpoint1->setMaximum(500);

        gridLayout_5->addWidget(setpoint1, 1, 1, 1, 1);

        setpoint1Label = new QLabel(layoutWidget);
        ...
        heaterRange1 = new QComboBox(layoutWidget);
        ...
        heaterOutput2Ohm = new QComboBox(layoutWidget);
        ...
        setpoint2 = new QDoubleSpinBox(layoutWidget);
        ...
        heaterRange2 = new QComboBox(layoutWidget);
        ...
        PIDPlot = new QwtPlot(layoutWidget);
        ...
        layoutWidget4 = new QWidget(tabBakeout);
        layoutWidget4->setObjectName(QString::fromUtf8("layoutWidget4"));
        layoutWidget4->setGeometry(QRect(10, 80, 741, 761));
        verticalLayout = new QVBoxLayout(layoutWidget4);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        pressurePlot1 = new trackingPlot(layoutWidget4);
        ...
        pressurePlot2 = new trackingPlot(layoutWidget4);
        ...
        ionGaugePlot = new trackingPlot(layoutWidget4);
        ...
        layoutWidget7->setGeometry(QRect(120, 10, 83, 74));
        ...
        TPDMass1 = new QSpinBox(layoutWidget7);
        TPDMass1->setObjectName(QString::fromUtf8("TPDMass1"));
        ...
        TPDMass2 = new QSpinBox(layoutWidget7);
        TPDMass2->setObjectName(QString::fromUtf8("TPDMass2"));
        ...
        TPDMass3 = new QSpinBox(layoutWidget7);
        TPDMass3->setObjectName(QString::fromUtf8("TPDMass3"));

        formLayout_6->setWidget(2, QFormLayout::FieldRole, TPDMass3);

        layoutWidget8 = new QWidget(tabTPD);
        layoutWidget8->setObjectName(QString::fromUtf8("layoutWidget8"));
        layoutWidget8->setGeometry(QRect(230, 20, 136, 34));
        formLayout_7 = new QFormLayout(layoutWidget8);
        ...
        temperature335 = new QLabel(layoutWidget8);
        ...
        temperatureThermocouple = new QLabel(layoutWidget8);
        ...
        layoutWidget9 = new QWidget(Form);
        layoutWidget9->setObjectName(QString::fromUtf8("layoutWidget9"));
        layoutWidget9->setGeometry(QRect(0, 0, 2, 2));
        formLayout_5 = new QFormLayout(layoutWidget9);
